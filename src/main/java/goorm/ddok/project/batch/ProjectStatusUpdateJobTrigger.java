package goorm.ddok.project.batch;
...
public class ProjectStatusUpdateJobTrigger {
    ...
    private void triggerInternal(String reason) {
        String name = projectStatusUpdateJob.getName();
        ...
        try {
            String today = LocalDate.now(ZoneId.of("Asia/Seoul")).toString(); // ISO-8601
            ...
            JobExecution exec = jobLauncher.run(projectStatusUpdateJob, params);
